...
#include "UnityCG.cginc"
            ...
            float4 frag (v2f i) : SV_Target{
                float currScreenX = (i.uv.x - MinimumScreenPositionX)/SimulatedScreenSizeX;
                float currScreenY = (i.uv.y - MinimumScreenPositionY)/SimulatedScreenSizeY;
